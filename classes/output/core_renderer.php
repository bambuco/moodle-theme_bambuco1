...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_bambuco1/lang_menu', $context);
            }
        }
    }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/bambuco1/pix";
    }
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (!isloggedin()) {
            ...
            return $this->render_from_template('theme_bambuco1/frontpage_guest_loginbtn', $context);
        }
    ...
    public function render_help_icon(help_icon $helpicon) {
        ...
        // Check issue https://github.com/willianmano/moodle-theme_bambuco1/issues/5.
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                ...
                                array('class' => 'bambuco1-search-input nav-link', 'id' => $identifier));
    }
    ...
    public function breadcrumb_header() {
        ...
        if ($this->page->pagelayout == 'mypublic') {
            $header->contextheader = "<h2>". get_string('userprofile', 'theme_bambuco1') ."</h2>";
        }

        return $this->render_from_template('theme_bambuco1/breadcrumb', $header);
    }
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themebambuco1settings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themebambuco1settings_fonttype', '');
        if ($fonttype) {
    ...
    public function full_header() {
        ...
        if ($this->page->pagelayout == 'course' && $this->page->user_allowed_editing()) {
            $header->editbutton = theme_bambuco1_edit_button();
        }
