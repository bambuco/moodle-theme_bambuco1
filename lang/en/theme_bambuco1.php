...
$string['pluginname'] = 'BambuCo 1';
$string['configtitle'] = 'BambuCo 1';
$string['choosereadme'] = 'BambuCo 1 is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['stayintouch'] = 'Información de contacto';
$string['by'] = 'Powered by';
$string['discipline_progress'] = 'Topic\'s progress';
$string['access'] = 'Access';
$string['cachedef_admininfos'] = 'Site administrator dashboard infos';
$string['cachedef_fontawesomebambuco1iconmapping'] = 'Fontawesome theme cache';
...
$string['legalabout'] = 'Legal information';
$string['loginguestlabel'] = 'Algunos cursos permiten el acceso de invitados';
$string['courses'] = 'Courses';
$string['mycourses'] = 'My courses';
$string['coursehidden'] = 'Este curso está oculto y los estudiantes no pueden acceder a él. <a href="{$a}">Haga clic aquí para actualizar la configuración</a>';
...
$string['secondarymenu'] = 'Secondary menu';
$string['secondarymenu_desc'] = 'Options to secondary top menu. Use the structure: link|title|target';
...
$string['sliderlink'] = 'Slide link';
$string['sliderlinkdesc'] = 'Add the slide\'s URI.';
...
$string['privacy:metadata:preference:themebambuco1settings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themebambuco1settings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themebambuco1settings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themebambuco1settings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';

// News.
$string['newssettings'] = 'News';
$string['newsorder'] = 'News order';
$string['newsorderdesc'] = '0 to hide the news.';
$string['newsimage'] = 'News image';
$string['newsimagedesc'] = 'Add an image for your news.';
$string['newslink'] = 'News link';
$string['newslinkdesc'] = 'The News item URL';
$string['newstext'] = 'News content';
$string['newstextdesc'] = 'The Text about the news';
$string['newstitle'] = 'Latest';
$string['newssubtitle'] = 'Mantente actualizado sobre nuestras actividades e información de interés.';

// Events.
$string['eventssettings'] = 'Events';
$string['eventorder'] = 'Event order';
$string['eventorderdesc'] = '0 to hide the event.';
$string['eventicon'] = 'Event icon';
$string['eventicondesc'] = '';
$string['eventimage'] = 'Event image';
$string['eventimagedesc'] = 'Add an image for the event.';
$string['eventlink'] = 'Event link';
$string['eventlinkdesc'] = 'The event item URL';
$string['eventtext'] = 'Event content';
$string['eventtextdesc'] = 'The text about the event';
$string['eventcolor'] = 'Event color';
$string['eventcolordesc'] = '';
$string['eventtitle'] = 'Memorias Virtuales';
$string['eventsubtitle'] = 'Memorias de los eventos, seminarios y diplomados.';


// Documents.
$string['documentssettings'] = 'Documents';
$string['documentorder'] = 'Document order';
$string['documentorderdesc'] = '0 to hide the document.';
$string['documenticon'] = 'Document icon';
$string['documenticondesc'] = '';
$string['documenticontext'] = 'Icon text';
$string['documenticontextdesc'] = 'Document type abbreviation.';
$string['documentlink'] = 'Document link';
$string['documentlinkdesc'] = 'The document item URL';
$string['documentname'] = 'Document title';
$string['documentnamedesc'] = 'The document name';
$string['documenttext'] = 'Document content';
$string['documenttextdesc'] = 'The text about the document';
$string['documenttype'] = 'Document type';
$string['documenttypedesc'] = '';
$string['documenttitle'] = 'Formatos Corporativos';
$string['documentsubtitle'] = 'En este espacio encontrarás los diferentes formatos y documentos institucionales.';
$string['documenttypelabel'] = 'Type: ';

// Contact information.
$string['contactsubtitle'] = 'Si requieres información o soporte comunícate con nosotros.';
$string['appstitle'] = 'Descargar la app Moodle';
$string['appssubtitle'] = 'Para que siempre estés conectado';
$string['mapurl'] = 'Map url';
$string['mapurldesc'] = '';
$string['address'] = 'Office address';
$string['addressdesc'] = '';
$string['appstore'] = 'App store';
$string['appstoredesc'] = 'Apple app store URL';
$string['googleplay'] = 'Google play';
$string['googleplaydesc'] = 'Google play store URL';
$string['recommendations'] = 'Recommendations';
$string['recommendationsdesc'] = '';
$string['urlcontactform'] = 'Contact form URL';
$string['urlcontactformdesc'] = '';
$string['captchacontactform'] = 'Contact form captcha';
$string['captchacontactformdesc'] = '';
